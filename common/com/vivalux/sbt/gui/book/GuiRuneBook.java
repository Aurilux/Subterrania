...
public class GuiRuneBook extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        String s1;
        int l;
            s = String.format(I18n.getString("book.pageIndicator"), new Object[] {Integer.valueOf(this.currPage + 1), Integer.valueOf(this.pages.length)});
            s1 = "";
	...
	GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        tessellator.addVertexWithUV(x + 0, y + y2, this.zLevel, 0, 1);//Bottom left
        tessellator.addVertexWithUV(x + x2, y + y2, this.zLevel, 1, 1);//Bottom right
        tessellator.addVertexWithUV(x + x2, y + 0, this.zLevel, 1, 0);//Top right
        tessellator.addVertexWithUV(x + 0, y + 0, this.zLevel, 0, 0); //Top left
        tessellator.draw();
